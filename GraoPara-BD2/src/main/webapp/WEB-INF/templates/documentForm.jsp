...
<tr>
	<td class="field"><select name="identificacao" class="inputLong"
		id="identificacao"><%=WebUtility.printSelectTituloCodiceCaixa(request, false)%></select></td>
	<td class="status"></td>
</tr>

<tr>
	<td class="tdForms"><label class="labelForms"
		id="lanoInicioCodiceCaixa" for="anoInicioCodiceCaixa">Ano
			Inicial do Códice/Caixa </label></td>
</tr>

<tr>
	<td class="field"><input class="input" name="anoInicioCodiceCaixa"
		id="anoInicioCodiceCaixa" type="text" size="20" maxlength="4"></td>
	<td class="status"></td>
</tr>

<tr>
	<td class="tdForms"><label class="labelForms"
		id="lanoFimCodiceCaixa" for="anoFimCodiceCaixa">Ano Final do
			Códice/Caixa </label></td>
</tr>

<tr>
	<td class="field"><input class="input" name="anoFimCodiceCaixa"
		id="anoFimCodiceCaixa" type="text" size="20" maxlength="4"></td>
	<td class="status"></td>
</tr>
...
<tr>
	<td class="field"><select name="tipo_num" class="inputTipoNum"
		id="tipo_num">
...
<tr>
	<td class="field"><input class="input" name="tituloDocumento"
		id="tituloDocumento" type="text" size="20" maxlength="1024"></td>
	<td class="status"></td>
</tr>
...
<tr>
	<td class="field"><input class="input" name="autor" id="autor"
		type="text" size="20" maxlength="1024"></td>
	<td class="status"></td>
</tr>
...
<tr>
	<td class="field"><input class="input" name="autorOcupacao"
		id="autorOcupacao" type="text" size="20" maxlength="48"></td>
	<td class="status"></td>
</tr>
...
<tr>
	<td class="field"><input class="input" name="destinatario"
		id="destinatario" type="text" size="20" maxlength="1024"></td>
	<td class="status"></td>
</tr>
...
<tr>
	<td class="field"><input class="input" name="destinatarioOcupacao"
		id="destinatarioOcupacao" type="text" size="20" maxlength="48"></td>
	<td class="status"></td>
</tr>
...
<tr>
	<td class="field"><input class="input" name="urlImagem"
		id="urlImagem" type="text" size="20" maxlength="1024"></td>
	<td class="status"></td>
</tr>
...
<tr>
	<td class="tdForms"><label class="labelForms"
		id="ldescricaoTipoDocumento" for="descricaoTipoDocumento">Descrição
			do Tipo de Documento </label></td>
</tr>

<tr>
	<td class="field"><input class="input"
		name="descricaoTipoDocumento" id="descricaoTipoDocumento" type="text"
		size="20" maxlength="1024"></td>
	<td class="status"></td>
</tr>
...
<tr>
	<td class="field"><textarea class="inputResumo" id="resumo"
			name="resumo" rows="7" cols="40" maxlength="2048"></textarea></td>
	<td class="status"></td>
</tr>
...
<tr>
	<td class="field"><select class="input" name="chave1" id="chave1"
		style="width: 120px"><option value="">Nenhuma</option>
			<%=WebUtility.printSelectKeyWords(request, "chave1", "Ação")%>
	</select></td>
	<td class="field"><select class="input" name="chave2" id="chave2"
		style="width: 120px"><option value="">Nenhuma</option>
			<%=WebUtility.printSelectKeyWords(request, "chave2",
					"Autores")%>
	</select></td>
	<td class="field"><select class="input" name="chave3" id="chave3"
		style="width: 120px"><option value="">Nenhuma</option>
