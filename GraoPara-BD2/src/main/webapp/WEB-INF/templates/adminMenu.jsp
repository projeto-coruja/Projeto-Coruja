...
<div class="bordaBox">
	<div class="conteudo">
		<article class="menuLateral">
			<ul class="nav" id="menu">			
				<li><a class="noBorderTop" href="cadastrarOrigem.jsp">Cadastrar Códice/Caixa</a></li>	
...
<div class="bordaBox">
	<div class="conteudo">
		<article class="menuLateral">
			<ul class="nav" id="menu">
				<li><a class="noBorderTop" href="tutorialPesquisa.jsp">Como Pesquisar no Acervo</a>
