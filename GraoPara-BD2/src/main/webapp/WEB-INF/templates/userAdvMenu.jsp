	...
	<div class="conteudo">
		<article class="menuLateral">
			<ul class="nav" id="menu">
				<li><a class="noBorderTop" href="/GraoPara/protected/userAdv/index.jsp">Home</a></li>
...
<div class="bordaBox">
	<div class="conteudo">
		<article class="menuLateral">
			<ul class="nav" id="menu">
				<li><a class="noBorderTop" href="/GraoPara/protected/userAdv/tutorialPesquisa.jsp">Como Pesquisar no Acervo</a></li>
