			...
			<div class="content" id="content">
				...
				<form action="/GraoPara/protected/admin/listagemDocumentos.jsp" id="signupform" method="get" name="cadastro">
					<table class="tablePesquisa">
						...
						<tr>
							<td class="tdPesquisa">
								<label class="labelForms" id="lbuscaGeral" for="buscaGeral">
									Busca por Qualquer Palavra:
								</label>
							</td>

							<td class="field">
								<input class="input" name="buscaGeral" id="buscaGeral" type="text" size="20" maxlength="100">
							</td>
						...
						<tr>
							...
							<td class="field">
								...
								<label class="labelForms" id="lcodigo" for="codigo"> até:</label>
						...
						<tr>
							<td class="tdPesquisa">
								<label class="labelForms" id="lautorOcupacao" for="autorOcupacao">
							...
							<td class="status">
								<a href="#">
									<img src="/GraoPara/images/icone_ajuda.png" alt="Ocupação do autor do documento. Por exemplo, Presidente da Província." title="Ocupação do autor do documento. Por exemplo, Presidente da Província." />
								</a>
							</td>
						</tr>
						...
						<tr>
							...
							<td class="status">
								<a href="#">
									<img src="/GraoPara/images/icone_ajuda.png" alt="Busca pelo nome completo ou parte do destinatário do Documento." title="Busca pelo nome completo ou parte do destinatário do Documento." />
								</a>
							</td>
						</tr>
						...
						<tr>
							...
							<td class="status">
								<a href="#">
									<img src="/GraoPara/images/icone_ajuda.png" alt="Trata-se do local em que foi escrito o documento, normalmente a cidade. Por exemplo, Belém." title="Trata-se do local em que foi escrito o documento, normalmente a cidade. Por exemplo, Belém." />
								</a>
							</td>
						</tr>
						...
						<tr>
							...
							<td class="status">
								<a href="#">
									<img src="/GraoPara/images/icone_ajuda.png" alt="Informe um período para filtrar a pesquisa." title="Informe um período para filtrar a pesquisa." />
								</a>
							</td>
						</tr>
						...
						<tr>
							...
							<td class="status">
								<a href="#">
									<img src="/GraoPara/images/icone_ajuda.png" alt="Selecione um dos tipos de documentos para filtrar resultados." title="Selecione um dos tipos de documentos para filtrar resultados." />
								</a>
							</td>
						</tr>
						...
						<tr>
							...
							<td class="status">
								<a href="#">
									<img src="/GraoPara/images/icone_ajuda.png" alt="Informe de uma a três palavras chaves para filtrar sua pesquisa" title="Informe de uma a três palavras chaves para filtrar sua pesquisa" />
								</a>
							</td>
						</tr>
