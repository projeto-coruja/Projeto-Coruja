	...
	<div class="container">
		...
		<div class="content" id="content">
			...
			<form id="signupform" autocomplete="off"
				action="/GraoPara/doChangesToAccount?action=editPassword"
				method="post">
				<table class="tableControle">
					<tr>
						<td colspan="3"><label class="labelForms"> <strong>MUDAR
									SENHA ATUAL</strong>
						</label></td>
					</tr>

					<tr>
						<td class="tdControle"><label class="labelForms"
							id="lpassword" for="password"> Senha Atual: <span
					...
					<tr>
						<td class="tdControle"><label class="labelForms"
							id="lpassword" for="password"> Nova Senha: <span
								class="asterisco">*</span>
						</label></td>
					...
					<tr>
						<td class="tdControle"><label class="labelForms"
							id="lpassword" for="password"> Confirme Nova Senha: <span
								class="asterisco">*</span>
						</label></td>
					...
					<tr>
						<td class="tdForms"><input class="buttonRegistrar"
							id="signupsubmit" name="Alterar" type="submit" value="Alterar" />
						</td>
					</tr>
				</table>
			</form>
